...
using coresolution.Models.TokenAuth;
...
{
    public abstract class coresolutionWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static coresolutionWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(coresolutionWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<coresolutionDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<coresolutionDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<coresolutionDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<coresolutionDbContext, Task<T>> func)
        {
            T result;
